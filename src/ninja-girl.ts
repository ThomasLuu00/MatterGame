...
class NinjaGirl extends Character{
    ...
    addAnimation(): void {
        ...
        let config = {
            'idle': {
                key: 'ninjagirl-idle',
                frames: this.scene.anims.generateFrameNames('ninjagirl-idle', {start: 0, end: 9, zeroPad: 2, prefix: 'ninjagirl-idle_'}),
                repeat: -1,
                frameRate: 30,
            },
            'run': {
                key: 'ninjagirl-run',
                frames: this.scene.anims.generateFrameNames('ninjagirl-run', {start: 0, end: 9, zeroPad: 2, prefix: 'ninjagirl-run_'}),
                repeat: -1,
                frameRate: 30,
            },
            'jump': {
                key: 'ninjagirl-jump',
                frames: this.scene.anims.generateFrameNames('ninjagirl-jump', {start: 0, end: 2, zeroPad: 2, prefix: 'ninjagirl-jump_'}),
                repeat: 0,
                frameRate: 30,
            },
            'throw': {
                key: 'ninjagirl-throw',
                frames: this.scene.anims.generateFrameNames('ninjagirl-throw', {start: 0, end: 9, zeroPad: 2, prefix: 'ninjagirl-throw_'}),
                repeat: -1,
                frameRate: 30,
            },
            'attack': {
                key: 'ninjagirl-attack',
                frames: this.scene.anims.generateFrameNames('ninjagirl-attack', {start: 0, end: 9, zeroPad: 2, prefix: 'ninjagirl-attack_'}),
                repeat: -1,
                frameRate: 30,
            },
            'jump-attack': {
                key: 'ninjagirl-jump-attack',
                frames: this.scene.anims.generateFrameNames('ninjagirl-jump-attack', {start: 0, end: 9, zeroPad: 2, prefix: 'ninjagirl-jump-attack_'}),
                repeat: -1,
                frameRate: 30,
            },
        }
...
const preloadNinjaGirl = (scene : Phaser.Scene) => {
    ...
    scene.load.atlas('ninjagirl-throw', '../assets/ninja_girl/ninja_girl_throw.png', '../assets/ninja_girl/ninja_girl_throw_atlas.json');
    scene.load.atlas('ninjagirl-attack', '../assets/ninja_girl/ninja_girl_attack.png', '../assets/ninja_girl/ninja_girl_attack_atlas.json');
    scene.load.atlas('ninjagirl-jump-attack', '../assets/ninja_girl/ninja_girl_jump_attack.png', '../assets/ninja_girl/ninja_girl_jump_attack_atlas.json');
}
